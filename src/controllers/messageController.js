...
let readMore = async (req, res) => {
  try {
    ...
    let imageModalData =  await renderFile("src/views/main/readMoreMessages/imageModal.ejs", dataToRender);

    let attachmentModalData =  await renderFile("src/views/main/readMoreMessages/attachmentModal.ejs", dataToRender);
